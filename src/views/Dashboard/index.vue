<template>
	<div class="min-h-screen bg-theme-60">
		<NavigationBar :activeUser="activeUser" />
				...
				<div class="flex gap-4 border-b border-slate-400 py-4">
					<button
						...
						:class="[
							...
							'cursor-pointer',
							'hover:text-theme-10',
							activeTab === 'for-edit' ? 'text-theme-30 font-semibold' : 'text-slate-400',
						]"
					>
						For Edit
					</button>
					<button
						...
						:class="[
							...
							'cursor-pointer',
							'hover:text-theme-10',
							activeTab === 'published' ? 'text-theme-30 font-semibold' : 'text-slate-400',
						]"
					>
						Published
					</button>
